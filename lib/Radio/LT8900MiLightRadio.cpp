...
// Constructor
/**************************************************************************/
LT8900MiLightRadio::LT8900MiLightRadio(unsigned char byCSPin, unsigned char byResetPin, unsigned char byPktFlag, const MiLightRadioConfig& config)
  : _config(config),
    _channel(0),
    _currentPacketLen(0),
    _currentPacketPos(0)
...
/**************************************************************************/
void LT8900MiLightRadio::regWrite16(unsigned char ADDR, unsigned char V1, unsigned char V2, unsigned char WAIT)
{
...
{
  unsigned char Length =  _out_packet[0];
...
/**************************************************************************/
bool LT8900MiLightRadio::sendPacket(uint8_t *data, size_t packetSize, unsigned char byChannel)
{
  if(_bConnected) // Must be connected to module otherwise it might lookup waiting for _pin_pktflag
  {
    ...
    for (unsigned char iCounter = 0; iCounter < packetSize; iCounter++)
    {
